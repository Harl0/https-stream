...
import uk.gov.hmrc.play.https.{HttpsStream, ConnectionProvider}
...
class SecureConnectionProviderImpl extends HttpsStream {
  ...
  val secureConnectionProvider: ConnectionProvider = new KeyStoreImpl()

}

class KeyStoreImpl extends ConnectionProvider {
